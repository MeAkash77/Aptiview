          ...
          <div className="grid lg:grid-cols-2 gap-16 items-center min-h-[75vh]">
            <motion.div initial={{ opacity: 0, x: -30 }} animate={isHeroInView ? { opacity: 1, x: 0 } : {}} transition={{ duration: 0.8, ease: "easeOut" }}>
              ...
              <motion.div className="flex flex-col sm:flex-row gap-4 mb-12" initial={{ opacity: 0, y: 20 }} animate={isHeroInView ? { opacity: 1, y: 0 } : {}} transition={{ delay: 0.5, duration: 0.6 }}>
                ...
                <Link href="https://drive.google.com/file/d/19_1dYetqw_Swwi9f5tm9GRYny7yroxJP/view?usp=drivesdk" aria-label="Watch product demo">
        ...
        <div className="py-16 px-4 sm:px-6 lg:px-8">
          <div className="max-w-7xl mx-auto">
            <div className="grid lg:grid-cols-4 gap-8 mb-12">
              <div className="lg:col-span-2">
                ...
                <p className="text-gray-400 mb-6 max-w-md leading-relaxed">
                  Revolutionizing recruitment with cutting-edge AI technology. We're building the future of hiring, one interview at a time.At the forefront of innovation, we are transforming the way organizations discover, evaluate, and hire talent. By harnessing the power of advanced AI, our platform goes beyond traditional recruitment methods streamlining the hiring process, reducing bias and ensuring that the best candidates are matched to the right roles.
                </p>

                <div className="flex space-x-3">
                  {[
                    { Icon: Twitter, href: "https://x.com/Akashp77", label: "Twitter" },
                    { Icon: Linkedin, href: "https://www.linkedin.com/in/me-akash77/", label: "Linkedin" },
                    { Icon: Github, href: "https://github.com/MeAkash77", label: "GitHub" },
                    { Icon: Mail, href: "iakshu845@gmail.com", label: "Email" },
            ...
            <div className="flex flex-col md:flex-row justify-between items-center">
              <div className="text-sm text-gray-400 mb-4 md:mb-0">© 2025 Aptiview. (Akash) All rights reserved.</div>
